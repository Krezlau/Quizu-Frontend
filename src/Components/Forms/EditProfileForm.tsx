...
const EditProfileForm = () => {
  return <div className="card bg-neutral p-4">
    ...
    <form className="mx-4 grid grid-rows-10 grid-cols-1 gap-4 lg:grid-cols-2 lg:grid-rows-5">
      ...
      <button type="submit" className="btn btn-primary mx-auto w-full row-start-11 col-span-1 lg:row-start-5 lg:col-span-2 sm:w-auto">Save</button>
    </form>
    ...
    <div className="flex flex-col gap-2 mx-4 sm:flex-row mb-4 sm:gap-8">
      <Link to={"/change-password"} className="btn btn-error btn-sm">Change password</Link>
