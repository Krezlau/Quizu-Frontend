...
const QuizCarousel: React.FC<{quizzes: IQuiz[], isLoading?: boolean}> = (props) => {
  ...
  return <div className="overflow-x-scroll flex flex-col gap-2 max-h-[40rem] md:carousel md:carousel-center p-4 bg-neutral md:flex-row md:space-x-4 rounded-box md:h-72 md:px-6" ref={carouselRef} onWheel={wheelHandler}>
